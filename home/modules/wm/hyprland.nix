  ...
  wayland.windowManager.hyprland.settings = {
    ...
    decoration = {
      ...
      shadow = {
        ...
        range = 4;
        render_power = 3;
        color = lib.mkDefault "rgba(${builtins.substring 1 6 c.accent}33)";
      };
    ...
    general = {
      ...
      gaps_out = 10;
      border_size = 1;
      "col.active_border" = lib.mkDefault "rgba(${builtins.substring 1 6 c.accent}ff) rgba(${builtins.substring 1 6 c.accentSoft}ff)";
      "col.inactive_border" = lib.mkDefault "rgba(${builtins.substring 1 6 c.muted}aa)";
